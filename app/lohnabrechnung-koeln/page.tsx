...
export default function LohnbuchhaltungKoeln() {
  return (
    <main style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif", background: '#f5f5f5', minHeight: '100vh', color: '#1a1a1a' }}>
      ...
      <section style={{ padding: '5rem 1.75rem 3rem', textAlign: 'center', maxWidth: '860px', margin: '0 auto' }}>
        <div style={{ display: 'inline-block', background: '#fff', border: '0.5px solid #e5e5e5', borderRadius: '20px', padding: '0.4rem 1rem', fontSize: '0.85rem', color: '#F97316', marginBottom: '2rem', fontWeight: 700 }}>Standort Köln</div>
        <h1 style={{ fontSize: '3rem', fontWeight: 700, lineHeight: 1.1, marginBottom: '1rem', color: '#1a1a1a' }}>
          Lohnabrechnung Köln – <span style={{ color: '#F97316' }}>digital & rechtssicher</span>
        </h1>
        <p style={{ fontSize: '1.15rem', color: '#666', lineHeight: 1.7, marginBottom: '2rem' }}>
          Ihr Lohnbüro für Köln und Umgebung. Wir übernehmen Ihre komplette Lohn- und Gehaltsabrechnung – pünktlich, fehlerfrei und zu einem fairen Festpreis.
        </p>
      ...
      <section className="section" style={{ padding: '3rem 1.75rem', maxWidth: '860px', margin: '0 auto' }}>
        <div style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', color: '#F97316', marginBottom: '0.5rem' }}>Köln & Umgebung</div>
        <h2 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '1rem', color: '#1a1a1a' }}>Lohnabrechnung für Kölner Unternehmen</h2>
        <p style={{ fontSize: '1rem', color: '#555', lineHeight: 1.8 }}>
          Köln ist eines der wichtigsten Wirtschaftszentren Deutschlands – mit starken Branchen in Medien, Handel, Versicherungen und dem Handwerk. Die Metropolregion Rheinland mit Bonn und Düsseldorf macht Köln zu einem der dichtesten Unternehmensstandorte Europas. Ob Medienunternehmen, Einzelhandel oder Baugewerbe – wir liefern rechtssichere Lohnabrechnungen für alle Branchen. Vollständig digital, ohne Vor-Ort-Termine und zu einem festen monatlichen Preis.
        </p>
      </section>
